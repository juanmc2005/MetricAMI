...
class Trainer:
    ...
    def __init__(self, loss_name: str, model: MetricNet,
                 loss_fn: nn.Module, partition: SimDatasetPartition,
                 optim: Optimizer, model_loader=None,
                 callbacks: list = None, last_metric_fn=None):
        self.loss_name = loss_name
        self.model = model.to(constants.DEVICE)
